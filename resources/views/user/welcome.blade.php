...
<body>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="ca-navbar">
                                <ul class="navbar-nav ml-auto" id="nav">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="#screenshot">News</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#pricing">Contact Us</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-md">
                    <div class="wellcome-heading">
                        <h2>Keluarga Mahasiswa Katholik</h2>
    ...
    <footer class="footer-social-icon text-center section_padding_70 clearfix">
        ...
        <div class="footer-social-icon">
            <a href="#" style="font-size: 0.5rem;"><i class="fab fa-line"></i></a>
            <a href="#" style="font-size: 0.5rem;"><i class="fab fa-instagram"></i></a>
            <a href="#" style="font-size: 0.5rem;"><i class="fab fa-facebook-square"></i></a>
        </div>
        <!-- Foooter Text-->
        <div class="copyright-text">
            <p>Copyright ©2018 KMK ITS. Designed by <a href="https://colorlib.com" target="_blank">Cete</a></p>
        </div>
    </footer>
    <!-- ***** Footer Area Start ***** -->
